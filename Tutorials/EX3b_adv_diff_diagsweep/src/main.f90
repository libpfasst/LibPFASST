...
contains
  ...
  subroutine run_pfasst()  
    ...
    type(pf_comm_t)   :: commD    !<  the communicator (here it is mpi)
    ...
    integer :: time_comm, diag_comm, time_color, diag_color, err
    ...
    !>  Set up communicator
    call pf_mpi_orthosplit(ntime, ndiag, time_comm, diag_comm, time_color, diag_color, MPI_COMM_WORLD)
