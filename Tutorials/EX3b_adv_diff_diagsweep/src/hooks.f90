...
contains
   ...
   subroutine echo_error(pf, level_index)
      ...
      print '("time: ", f10.4," step: ", i3.3," rank(pf,d): ",i3.2 ,i3.2," iter: ",i4.3," level: ",i2.2," error: ",es14.7," res: ",es14.7)', &
         time, step, rank, rankD, iter,level_index, maxerr,resid
