module probin
  ...
  integer, save :: do_both          ! set to 1 to sweep on state and adjoint simultaneously (with communication in adjoint)
  ...
  namelist /params/  do_imex, warmstart, do_mixed, do_both, logfile, nsweeps, nsweeps_pred
