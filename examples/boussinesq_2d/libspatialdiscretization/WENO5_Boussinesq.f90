...
TYPE fdm_parameter
	...
	LOGICAL :: echo_on
        DOUBLE PRECISION :: stabFreq, c_s, grav
END TYPE
...
CONTAINS
	...
	SUBROUTINE InitializeFiniteVolumes(Nx_max, Ny_max, Nthreads, mpi_init_thread, echo_on, c_s, stabFreq, grav)
	
		INTEGER, INTENT(IN) :: Nthreads, Ny_max, Nx_max, mpi_init_thread
		LOGICAL, INTENT(IN) :: echo_on
                DOUBLE PRECISION, INTENT(IN) :: c_s, stabFreq, grav
