...
module probin
  ...
  namelist /params/  pfasst_nml, lam1,lam2,a,b,c, nu, t00, sigma, beta,splitting
...
contains
  ...
  subroutine print_loc_options(pf, un_opt)
    ...
    write(un,*) 'nsteps_rk: ', nsteps_rk, '! Number of rk substeps'
    write(un,*) 'rk_order: ', rk_order, '! Order of rk substeps'        
    ...
    case (1)  
       ...
       write(un,*) 'a,b,c:   ',  a,b,c, '! advection velocities'
       ...
       case DEFAULT
          call pf_stop(__FILE__,__LINE__,'Bad case for ic_type in probin',ic_type)
       end select
    case (2)  
    ...
    case DEFAULT
       call pf_stop(__FILE__,__LINE__,'Bad case for eq_type in probin',eq_type)
    end select
