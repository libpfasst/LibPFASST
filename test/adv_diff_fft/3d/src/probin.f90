...
module probin
  ...
  real(pfdp), save :: a,b,c      ! advection velocity
  ...
  integer, save :: nz(PF_MAXLEVS)     ! number of grid points  
  ...
  integer :: ios,iostat
  namelist /params/  nx,ny,nz,nprob, nsteps,nsteps_rk, dt, Tfin
  namelist /params/  pfasst_nml, a,b,c, nu, t00, sigma, kfreq,imex_stat
...
contains
  ...
  subroutine print_loc_options(pf, un_opt)
    ...
    write(un,*) 'a,b,c:  ',  a,b,c, '! advection constants'
