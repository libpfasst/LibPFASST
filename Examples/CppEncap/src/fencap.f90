...
module encap
   ...
   interface
     ! function ScalarCreate() result(x) bind(c, name="ScalarCreate")
     !    use iso_c_binding
     !    type(c_ptr) :: x
     ! end function
     ...
     ! subroutine ScalarPack(x, z) bind(c, name="ScalarPack")
     !    use iso_c_binding
     !    type(c_ptr), intent(in) :: x
     !    !type(c_ptr), value :: x
     !    type(c_ptr), intent(out) :: z
     ! end subroutine ScalarPack
     ...
     ! subroutine ScalarNorm(x, norm) bind(c, name="ScalarNorm")
     !   use iso_c_binding
     !   type(c_ptr), value :: x
