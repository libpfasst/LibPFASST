...
contains
  ...
  subroutine run_pfasst()  
    ...
    class(pf_encap_t), allocatable :: y_0_base, y_end_base
    ...
    call sf%create_single(y_0_base, level_index, shape_in)
    call sf%create_single(y_end_base, level_index, shape_in)
    y_0 = cast_as_scalar(y_0_base)
    y_end = cast_as_scalar(y_end_base)
