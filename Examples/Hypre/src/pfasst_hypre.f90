...
contains
  ...
  subroutine PfasstHypreInit(pf, mg_ld, lev_shape, space_color, time_color, spatial_coarsen_flag) 
    ...
    integer, intent(in) :: spatial_coarsen_flag
    ...
    do l = 1,pf%nlevels
       ...
       lev_shape(l,10) = spatial_coarsen_flag
